...
export interface ProjectsProps {
  ...
  const projects: ProjectsProps[] = [
    ...
    },
    {
      ...
      "description-2": "As the full stack developer, I led the project using Next.js, TypeScript, and Material UI, building a responsive and visually appealing design. Advanced SEO strategies were implemented, resulting in a 30% boost in organic enrollment. Firebase was integrated to securely store photos and videos, as well as manage email functionalities, ensuring efficient performance and scalability.",
      "description-3": "Additionally, the project reflects a strong commitment to user experience and performance optimization. Regular stakeholder feedback and iterative design refinements led to robust error handling and smooth interactions, ultimately elevating the dancer's online presence and engagement.",
      "stack": ["Next.js", "TypeScript", "Material UI", "Firebase", "SEO Best Practices", "Responsive Design"]
    },       
    {
      "id": 3,
      "images": [
      ...
      "description-2": "In my role as the front-end developer, I built the prototype using React, TypeScript, and Styled-components, with a meticulously designed UI in Figma. The integration of Supabase ensured robust API management for secure user authentication and data handling, while third-party APIs enriched the platform’s content.",
      "description-3": "This project not only enhanced accessibility to educational resources but also demonstrated the innovative use of modern web technologies to create a scalable, user-centric platform. Continuous improvements and future enhancements are planned to further expand the library’s capabilities and reach.",
      "stack": ["React", "TypeScript", "Styled-components", "Figma", "Supabase", "REST APIs"]
    },
    {
      "id": 4,
      "images": [
      ...
      "description-2": "Developed using HTML, CSS, and vanilla JavaScript, this project emphasizes clarity and simplicity in design. Users can initiate different sorting processes, compare algorithm efficiencies, and observe how each method manipulates data, transforming abstract concepts into tangible visual experiences.",
      "description-3": "Serving as an effective educational tool, the application demystifies complex algorithmic processes. Its clear visual feedback and interactive controls empower learners to experiment with various sorting techniques and deepen their understanding of algorithm design and performance.",
