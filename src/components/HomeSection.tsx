...
const HomeSection: React.FC = () => {
  ...
  return (
    <Grid2 spacing={3} container  justifyContent="space-between"
      id="home"
      sx={{
        width: "100%",
    ...
    >
      ...
      >
        ...
        <Typography variant="h2" sx={{ mt: 2, color: theme.palette.common.secondTextColor }}>
          A passionate Front-end Developer dedicated to creating stunning digital experiences.
        </Typography>

        <Grid2 sx={{ display: "flex", alignItems: "center", mt: 10 }}>
            <a
             href="/HANS TOUSSAINT Front end developper.pdf"
             download
             style={{
               display: "flex",
               alignItems: "center",
            ...
            >
                ...
                <Download sx={{ cursor: "pointer", verticalAlign: "middle", color: theme.palette.common.redColor }} />
            </a>
        </Grid2>
