...
const sections = [
  { id: "home", label: "Home", bg: theme.palette.common.white },
  {
    id: "services",
    label: "My Expertise",
    bg: theme.palette.common.secondBgColor,
  },
              ...
              >
                  ...
                  <Service
                    icon={
                      <ColoredIcon
                        ...
                        }icons/front-end-programming.png`}
                      />
                    }
                ...
                <Grid2 display="flex">
                  <Service
                    icon={
                      <ColoredIcon
                        src={`${import.meta.env.BASE_URL}icons/back-end.png`}
                      />
                    }
                ...
                <Grid2 display="flex">
                  <Service
                    icon={
                      <ColoredIcon
                        src={`${import.meta.env.BASE_URL}icons/ux-design.png`}
                      />
                    }
                    title="Web Design"
                    options={[
